...
**624 tests**, plus 20 more from the interactive planner (`drp serve`, roadmap §2.1) --
12 for the server's request handling in `test_server.py` and 8 more in `tests/browser/`
