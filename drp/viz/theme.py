...
``chart``
    The original aeronautical-chart identity. Kept exactly as it was, so any
    committed figure can be regenerated byte-for-byte.
...
CHART = Theme(
    ...
    description=("The original palette. Adjacent red and green: its worst pair "
                 "falls to dE 7.8 under deuteranopia. Kept so committed figures "
